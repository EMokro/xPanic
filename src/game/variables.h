...
MACRO_CONFIG_INT(SvExpKillZombie, sv_exp_kill_player, 1, 0, 100, CFGFLAG_SERVER, "The exp you get when you kill a player")
MACRO_CONFIG_INT(SvExpKillTrurret, sv_exp_kill_turret, 1, 0, 100, CFGFLAG_SERVER, "The exp you get when you destroy a turret")
MACRO_CONFIG_INT(SvExpKillPlayer, sv_kill_zombie, 3, 0, 100, CFGFLAG_SERVER, "The exp you get when you kill a zombie")
MACRO_CONFIG_INT(SvWinReward, sv_win_reward, 5, 0, 100, CFGFLAG_SERVER, "Reward a user gets after winning")
MACRO_CONFIG_INT(SvLooseReward, sv_loose_reward, 1, 0, 100, CFGFLAG_SERVER, "Reward a user gets after loosing")
